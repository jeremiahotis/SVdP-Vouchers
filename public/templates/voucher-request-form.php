<div class="svdp-voucher-form">
    <div class="svdp-instructions">
        ...
        <p><strong>What are Virtual Clothing Vouchers?</strong><br>
        Virtual Clothing Vouchers replace paper vouchers and allow your Neighbors to access the clothing they need in a dignified manner that maintains their self-respect and gives them the power of personal choice.</p>
    ...
    <form id="svdpVoucherForm" class="svdp-form">
        ...
        <div class="svdp-form-row">
            <div class="svdp-form-group">
                ...
                <small class="svdp-help-text">Each household member receives $20. Please count all adults.</small>
            </div>
            
            <div class="svdp-form-group">
                <label>How many children (under 18) are in your Neighbor's household? *</label>
                <input type="number" name="children" min="0" value="0">
                <small class="svdp-help-text">Each household member receives $20. Please count all children.</small>
            </div>
        </div>
        
        <h3>Your Information</h3>
        
        <?php if (empty($atts['conference'])): ?>
        <div class="svdp-form-group">
            <label>What Conference are you with? *</label>
            <select name="conference" required>
                <option value="">Select your Conference...</option>
                <?php foreach ($conferences as $conf): ?>
                    <?php if (!$conf->is_emergency): ?>
