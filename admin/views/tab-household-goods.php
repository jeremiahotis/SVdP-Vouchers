<div class="svdp-catalog-tab">
    <div class="svdp-card">
        ...
        <p class="description">Manage the global list of household goods items available for vouchers.</p>
        ...
        <form id="svdp-add-household-item" class="svdp-catalog-form" data-catalog-type="household">
            <table class="form-table">
                ...
                <tr>
                    <th><label for="household_min_price">Min Price *</label></th>
                    <td><input type="number" id="household_min_price" name="min_price" step="0.01" min="0" required></td>
                </tr>
                <tr>
            ...
            <p class="submit">
                <button type="submit" class="button button-primary">Add Household Item</button>
            </p>
        </form>
        <div id="household-item-message"></div>
    </div>

    <div class="svdp-card">
        <h2>Existing Household Goods Items</h2>
